...
class AgentRecord:
    ...
    def get_best_capability(self) -> Optional[Tuple[str, AgentCapabilityRecord]]:
        ...
        best_name = max(self.capabilities.keys(), 
                       key=lambda k: self.capabilities[k].final_fitness)
...
class AgentPersistence:
    ...
    def save_trained_network(self, agent_id: str, capability_type: str, 
                           network: neat.nn.FeedForwardNetwork, 
                           genome: neat.DefaultGenome) -> str:
        """
    ...
    def load_agent_record(self, agent_id: str) -> Optional[AgentRecord]:
        ...
        try:
            ...
            with open(genome_path, 'rb') as f:
                constitutional_genome = pickle.load(f)
    ...
    def load_trained_network(self, agent_id: str, capability_type: str) -> Optional[Tuple[neat.nn.FeedForwardNetwork, neat.DefaultGenome]]:
        """
    ...
    def create_agent_record_from_training(self, identity_bundle: IdentityBundle,
                                        training_result: Dict[str, Any],
                                        capability_type: str,
                                        lineage: Optional[Dict[str, str]] = None) -> AgentRecord:
        """
        ...
        return AgentRecord(
            ...
            lineage=lineage or {},
            notes=f"Trained in {capability_type} with fitness {training_result.get('final_fitness', 0.0):.3f}"
        )


# Convenience functions for common operations
def save_training_result(training_result: Dict[str, Any], capability_type: str,
                        agents_dir: str = "agents") -> str:
    """
    ...
    # Save agent
    agent_dir = persistence.save_agent(agent_record)
